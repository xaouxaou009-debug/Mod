...
local XMC_Sections = {
    quick = {title="เมนู ฟังก์ชั่น", desc="ฟังก์ชันที่ ACS_Mod มีอยู่ตอนนี้", features={
        {text="เสกไอเทม", action="item"}, {text="เปิดใจ+เพิ่มความสัมพันธ์", action="jianghu"},
         {text="เรียกบอส", action="boss"}, {text="เปิดคลังจักรวาล", action="space"},
         {text="เปิด-ปิด ก่อสร้าง", action="tools"}, {text="เครื่องมือโลกและไอเทม", action="world_tools"},
         {text="เวลา / ฤดูกาล / อากาศ", action="time_weather"},
