...
function XaouItemWindow:GetModeName(mode)
    ...
    if mode == "warp" then return "วาร์ป" end
...
function XaouItemWindow:OnInit()   -- แก้ขนาดกรอบ
    ...
    -- self. = self:AddButton("", "วาร์ป", 1000, 350, 140, 100, "Sprs/xaou103.png")
...
function XaouItemWindow:RefreshWarpPage()
    ...
    pcall(function() self.statusLine1.m_title.text = "ระบบวาร์ป / แผนที่" end)
