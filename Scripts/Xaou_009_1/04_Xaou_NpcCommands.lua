...
function Xaou_GetNpcCommands(page)
    ...
    elseif page == "more" then
        return {
            ...
            { text="8. สร้างฟรี ON/OFF", actions={{kind="modfunc", mod="Xaou009_ACS_Mod", func="ToggleFreeBuild"}} },
            { text="9. สร้างด่วน ON/OFF", actions={{kind="modfunc", mod="Xaou009_ACS_Mod", func="ToggleQuickBuild"}} },
