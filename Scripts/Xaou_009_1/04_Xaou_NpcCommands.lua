...
function Xaou_GetNpcCommands(page)
    ...
    elseif page == "more" then
        return {
            ...
            { text="4. จักรวาลย่อส่วน", page="qianKun" },
            { text="5. ขโมยของ NPC", actions={{kind="addmodifier", id="Dan_BaiYanLang76"}} },
            { text="6. เพิ่มค่าสถานะทั้ง 5", actions={{kind="addmodifier", id="QuanBu76"}} },
            { text="7. ยืดเวลาของทัณฑ์สวรรค์", actions={{kind="addmodifier", id="Dan_ZhongLi76"}} },
            { text="8. เปลียนเวลาของเกม", page="Xaou_1" },
            { text="9. สร้างด่วน ON/OFF", actions={{kind="modfunc", mod="Xiu_Gai_Qi_761152306", func="ToggleQuickBuild"}} },
            { text="10. หน้าถัดไป ▶", page="more1" },
        }
        
    elseif page == "more1" then
        return {
            { text="ปลดล็อกวิชาบ่มเพาะสายหลักทั้งหมด", actions={{kind="story", story="xaou2000"}} },
            { text="2. สร้างฟรี ON/OFF", actions={{kind="modfunc", mod="Xiu_Gai_Qi_761152306", func="ToggleFreeBuild"}} },
            { text="1. กกก", actions={{kind="addmodifier", id="xaou2000"}} },
    ...
    elseif page == "qianKun" then
        return {
            { text="1. ตรวจสอบจักรวาลย่อส่วน", actions={{kind="story", story="System_EnterQianKunJie"}} },
            { text="2. เข้าจักรวาลย่อส่วน", actions={{kind="enter_qiankun"}} },
            { text="3. เปิดเมนูจักรวาลย่อส่วนเดิม", actions={{kind="story", story="Xaou_Menu_QianKun"}} },
            { text="4. เก็บของอัตโนมัติ", actions={{kind="message", title="จักรวาลย่อส่วน", text="ฟังก์ชัน Auto Collect ให้ผูกกับระบบ AutoSleeveSpace ต่อ"}} },
            { text="5. ◀ กลับ", page="more" },
        }
